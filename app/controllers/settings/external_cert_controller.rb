...
class Settings::ExternalCertController < SettingsController
  ...
  def set_instance_variables
    ...
    # @subject_alt_names = {
    #   VELUM_HASH_KEY => [1, 2, 3, 4],
    #   KUBEAPI_HASH_KEY => [5, 6],
    #   DEX_HASH_KEY => [7, 8, 9, 0],
    # }
    # @k = Velum::Salt.call(
    #   action: "pillar.items",
    #   targets: "admin",
    ...
    # @k = get_san_array(read_cert(Pillar.value(pillar: :external_cert_velum_cert)))
    @k = build_subject_alt_names[KUBEAPI_HASH_KEY]
  end
